...
const useHelpCommand = async (ctx: ContextType) => {
  ...
  \nКурс обмена *UnionPay* обновляется по рабочим дням в 15:30 (GMT +7). В выходные и будние до 15:30 (GMT +7) курс *UnionPay* будет равен курсу предыдущего рабочего дня.
  \n❗️*ВНИМАНИЕ*❗️
