...
declare const isOutdated: (timestamp: number) => boolean;
declare const formatDate: (date: string | Date, formatT: string) => string;
...
export { toFixedNumber, escapeChars, replaceComma, isNumeric, isTodayDate, isYesterdayDate, isOutdated, isWeekendDate, formatDate, hasActualRate, getPercentageOfNumber, getTodayDate, getPrevDate, getHumanizedDateRate, formatTextToEqualBlockWidth, };
